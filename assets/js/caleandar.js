...
// shows labels
// {m} view modeï¼Œ{d}dateï¼Œ{v}value
// false = disable
        label: '{d}\n{v}',
  ...
  Calendar.prototype = {
    ...
    event: function() {
      ...
      _this.$element.on('click', ARROW_DATE, function() {
        ...
        setTimeout(function(){ vc('date', d.y, d.m); }, 500);   // by blackgak, memberi jeda untuk update jadwal
    ...
    setData: function(data) {
      ...
      if (this.view === 'date') {
        ...
        this.updateDateView(d[0], d[1]);  //by blackgak
