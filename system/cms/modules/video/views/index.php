<div class="row">
 <h1 class="section-header" style="margin-top:100px;margin-bottom:50px">VIDEO</h1>
...
?>
      ...
      <div class="news_item news_i">
		...
		<iframe width="100%" height="180" src="<?php echo $post->url?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <span>
