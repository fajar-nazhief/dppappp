...

{
...

	{
		...
		echo ">>>".$title . $this->post->title_asli();

		if($title != $this->post->title_asli()){
...

	{
		...
		$lama = url_title(strtolower($this->input->post('title_asli')));

		  

		 if($group != $lama){

		if ( ! $this->news_categories_m->check_title($group))
