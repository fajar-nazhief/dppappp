		...
		<tbody>
			<?php  foreach ($news as $article): ?>
				<tr>
					...
					<td><?php  echo $article->title;?><br><?php   echo 'news/' .date('Y/m', $article->created_on) .'/'. $article->slug;?></td>
					<td><?php  echo $article->category_title;?><br><?php   echo 'news/category/'. $article->category_slug;?></td>
					...
					<td>
						...
						<?php  echo anchor('admin/news/selesai/' . $article->id, 'Selesai Pilihan Editor');?>
						<?php   }else{?>
						<?php  echo anchor('admin/news/pilih/' . $article->id, 'Pilihan Editor');?>
						<?php   }?>
