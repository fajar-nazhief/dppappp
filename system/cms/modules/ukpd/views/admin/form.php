...
<div class="panel-body">
	...
	<?php echo form_input('nama_ukpd', htmlspecialchars_decode(@$post->nama_ukpd), 'maxlength="100" class="form-control input-sm"'); ?>
...
<div class="form-group">
	<label> Kontak </label> 
	<?php echo form_input('kontak', htmlspecialchars_decode(@$post->kontak), 'maxlength="100" class="form-control input-sm"'); ?>
	<span class="required-icon tooltip">title</span>
