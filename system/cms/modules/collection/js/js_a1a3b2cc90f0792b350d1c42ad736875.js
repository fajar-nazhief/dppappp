...
Drupal.behaviors.wh_forms_get_updates_modal = function (context) {
  $("#header-link-get-email-updates a").click(function () {
            ...
            $.ajax({  
              ...
              url: "/get-email-updates",  
                ...
                success: function() {
                  ...
                  setTimeout(function() { $('#get-email-updates-modal').slideToggle('fast'); }, 4000);
               }
            });
          }
...
Drupal.behaviors.wh_theme = function(context) { 
  ...
  var defaultSearchText = Drupal.t('Search Djanfaridz.com');
...
Drupal.behaviors.wh_utility_featured_horizontal_slider = function(context) {
  var sliders = $('ul.fhs');
  jQuery.each(sliders, function(index, value) {
    ...
    controlLeft.click(function(event) {
      ...
      if (!animating && (parseInt(slider.css('margin-left')) < 0)) {
        deanimate();
        i--;
    ...
    controlRight.click(function(event) {
      event.preventDefault();
      if ((!animating && parseInt(slider.css('margin-left')) > -max)) {
        deanimate();
        i++;
        slider.animate({marginLeft:'-='+increment},700,reanimate);
      }
  ...
  $(document).bind('click', function(e) {
    if( (!$.browser.msie && e.button == 0) || ($.browser.msie) ) {
      ...
      if (nodename == 'A') {
        ...
        if ( !link_address.match(host) && link_address.match('index.html') && !link_address.match('whitehouse.gov') && !link_address.match('wh.gov') ) {
