...
<div class="navbar" style="margin:10px">
              <div class="navbar-inner">
                <?php   echo form_open('collection/search',array('class'=>'navbar-form '));?>
 <?php 
...
<?php  foreach ($berita as $article): ?>
	<div class="collection_article" style="border:1px dotted #dedede;margin:10px;padding:10px">
		<!-- Article heading -->
		<div class="article_heading">
			<div style="font-size:15px;font-weight:bold;color:#0D4A86"><?php  echo  anchor('collection/' .date('Y/m', $article->created_on) .'/'. $article->slug, $article->title); ?></div>
			<p class="article_date"><?php  echo lang('collection_posted_label');?>: <?php  $date = date_create($article->datecreated);?>
