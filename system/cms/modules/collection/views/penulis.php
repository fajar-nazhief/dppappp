...
<div style="border-bottom:1px solid #dedede;padding:10px">
        ...
        <div class="post-content">
			...
			<h5><?php  echo  anchor('collection/' .date('Y/m', $article->created_on) .'/'. $article->slug, $article->title,'  '); ?></h5>
			<span class="comm_bubble">
				<a href="<?php  echo base_url()?>collection/<?php  echo date('Y/m',$article->created_on)?>/<?php  echo $article->slug?>" class=" " title="<?php   echo $article->title?>"><?php   echo $article->total_comment?></a>
