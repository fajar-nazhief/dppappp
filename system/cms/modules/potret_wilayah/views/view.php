...
?>
      ...
      <div class="news_item news_i">
        ...
        <span class="news_item_preview">
          <a href="javascript:void(0)" data-js="1" onClick="openmodal('<?php echo base_url().'uploads/potret-wilayah/'.$post->img_thumb?>')">
            <img src="<?php echo base_url().'uploads/potret-wilayah/'.$post->img_thumb?>" alt="<?php echo $post->title_caption?>" /><span>
