	...
	<div>
	 ...
	 <div class="panel panel-default">
				...
				<tr>
					...
					<td><b><?php echo $post->title; ?></b>
					<span style="font-size:11px"><br><?php echo $post->alamat?><br>Telp: <?php echo $post->no_telp?><br>Email: <?php echo $post->email?></span></td>
			...
			<td><?php echo $post->pekerjaan; ?></td>
			<td><?php echo $post->rincian; ?></td>
			<td><?php echo $post->tujuan; ?></td>
