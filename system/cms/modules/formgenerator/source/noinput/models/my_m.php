...
class My_m extends MY_Model {
	...
	protected $_table = 'Gantinama';

	function get_all()
	{   
		$this->db->select($this->MNAME.'.*, Gantirelasi.title AS category_title, Gantirelasi.slug AS category_slug');
		$this->db->join('Gantirelasi', $this->MNAME.'.category_id = Gantirelasi.id', 'left');
