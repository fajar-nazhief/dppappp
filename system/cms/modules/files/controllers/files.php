...

{
	...
	public function list_files($id = 0)

	{
		$this->db->where('folder_id','72');
		$this->db->order_by('name','ASC');
		$this->data->res=$this->db->get('files')->result();
		$this->template->title('Download PDF', 'Produk Hukum Dinas Kebudayaan DKI Jakarta' )	   
	...
	public function thumb($id, $width = 210, $height = 148, $mode = NULL)

	{
		...
		$image_thumb=$this->_path.'thumb/'.substr($file->filename,0,-4).'_thumb'.$file->extension;
