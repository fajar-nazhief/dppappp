	...
	<div class="container">
					<div class="panel">
					           ...
					           <div class="form-group" id="demo-dp-txtinput">
					                                <input name="date_from" id="date_from"  class="form-control" value="<?php echo @$_SESSION['date_from']?>" type="text">
					                            </div>
					           To 
					           <div class="form-group" id="demo-dp-txtinput">
					                                <input name="date_end" id="date_end" class="form-control" value="<?php echo @$_SESSION['date_end']?>" type="text">
					                            </div>
					            <button class="btn btn-primary" type="submit" name="search" value="Submit">Submit</button>
													...
													<a href="<?php echo base_url()?>event/create"  class="btn btn-danger btn-icon"><i class="demo-psi-pen-5 icon-lg"></i> Send Us Your Event</a>
													   <a href="<?php echo str_replace(array('/search'),array('/search_download'),$this->uri->uri_string())?>" alt="Download Xls." class="btn btn-success btn-icon"><i class="fa fa-download  icon-lg"></i> </a>
