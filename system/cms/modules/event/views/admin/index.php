...
<div class="panel panel-default">
					<div class="panel-heading">Download Kalender Event Excel</div>
					<div class="panel-body">
<form class="form-inline no-margin" action="<?php echo base_url()?>admin/<?php echo $this->nama_modul?>/download_kalender_event" method="post" accept-charset="utf-8">
 <div class="row">
		<div class="col-md-9">
			<div class="form-group" >
                <input name="date_from_xls" id="date_from_xls"  placeholder="Date Start" class="form-control"  type="text" class="form-control datepicker">
			</div>
			<div class="form-group" >
				<input name="date_end_xls" id="date_end_xls" placeholder="Date End" class="form-control" value="<?php echo @$_SESSION['date_end']?>" type="text">
			</div>
			<div class="input-group">
				<button type="submit" class="btn btn-success btn-sm">Download Kalender Xls</button>
			</div>
	...
	<div>
	 <div class="panel panel-default">
			...
			//		$json =  unserialize($post->json_data) ;?></td>
					...
					<td><?php echo ($post->date_from); ?></td>
					<td><?php echo ($post->date_end); ?></td>
					<td>
					<?php if ($post->author): ?>
					...
					<td class="align-center buttons buttons-small">
						<div class="btn-group">
							...
							<?php if($post->pilihan_editor == 0){?>
							<li><?php echo anchor('admin/event/pilihaneditor/' . $post->id, 'Penting', 'class="button edit"'); ?></li>
							<?php }else{?>
							<li><?php echo anchor('admin/event/pilihaneditor/' . $post->id, 'Stop Penting', 'class="button edit"'); ?></li>
							<?php }?>
								<li class="divider"></li>
