...
<div class="panel-body">
						<form class="form-inline no-margin" action="<?php echo site_url('admin/'.$this->nama_modul.'/categories/search')?>" method="post">
							<div class="row">
								<div class="col-md-5">
	...
	<?php echo form_open('admin/'.$this->nama_modul.'/categories/delete'); ?>
	...
	<table border="0" class="table table-bordered table-condensed table-hover table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo site_url($this->nama_modul.'/category/'.$category->slug)?>
				</td>
                ...
                <td class="align-center buttons buttons-small">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li>	<?php echo anchor('admin/'.$this->nama_modul.'/categories/edit/' . $category->id, lang('cat_edit_label'), 'class="button edit"'); ?> </li>
								<li><?php echo anchor('admin/'.$this->nama_modul.'/categories/delete/' . $category->id, lang('cat_delete_label'), 'class="confirm button delete confirm PopConfirm_open"') ;?>   </li>
