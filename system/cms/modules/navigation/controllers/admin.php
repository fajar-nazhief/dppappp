...
class Admin extends Admin_Controller
{
	...
	public function index()
	{
		...
		//print_r($this->data->navigation['1']);
	...
	public function create($group_id = '')
	{
		...
		foreach($this->validation_rules as $rule)
		{
		 ...
		 $this->data->navigation_tree = $this->navigation_m->get_link_tree($group_id);//print_r($this->data->navigation_tree);
		 $this->data->controller=&$this;
		// Get Pages and create pages tree
		$this->data->tree_select = $this->_build_tree_select(array('current_parent' => $this->data->navigation_link->page_id));
		$this->data->menu_banner=$this->file_m->getFile(array('folder_id'=>'3'));
	...
	public function edit($id = 0)
	{
		...
		//tree menu
		$group_id=$this->data->navigation_link->navigation_group_id;
		$this->data->navigation_tree = $this->navigation_m->get_link_tree($group_id);//print_r($this->data->navigation_tree);
		$this->data->controller=&$this;
		// Get Pages and create pages tree
		$this->data->tree_select = $this->_build_tree_select(array('current_parent' => $this->data->navigation_link->page_id));
	...
	public function navigation_tree_builder($link, $group_id)
	{
		if ($link['children']):
				...
				foreach($link['children'] as $link): ?>
					 ...
					 <option value="<?php  echo $link['id']?>">
							&raquo; <?php  echo $link['title'];?>
						 
					 </option>
				<?php  if ($link['children']): ?>
						 
								<?php  $this->navigation_tree_builder($link, $group_id); ?>
