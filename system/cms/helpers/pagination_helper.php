...
function create_pagination_blog($uri, $total_rows, $limit = NULL, $uri_segment = 4, $full_tag_wrap = TRUE)
{
	...
	$config['full_tag_open'] = '<div class="pagination_wrapper"><ul class="pagination pagination-centered">';
	...
	$config['cur_tag_open'] = '<li class="m-active"><a href="javascript:void(0)">';
	$config['cur_tag_close'] = '</a></li>';
