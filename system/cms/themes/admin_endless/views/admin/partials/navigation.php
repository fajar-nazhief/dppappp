<div class="main-menu">
	<ul>
		<li>
		<a href="<?php echo base_url().'admin'?>"><span class="text"><?php echo lang('cp_admin_home_title')?></span><span class="menu-hover"></span></a>
...
echo '<a href="#" class="'.$class.'"><span class="text">'.$name.'</span><span class="menu-hover"></span></a>';
					echo '<span class="menu-hover"></span><ul class="submenu">';
