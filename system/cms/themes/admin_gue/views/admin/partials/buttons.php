<?php if (isset($buttons) && is_array($buttons)): ?>
	<?php foreach ($buttons as $key => $button): ?>
		...
		<?php switch ($button) :
			case 'delete': ?>
				<button type="submit" name="btnAction" value="delete" class="btn btn-danger confirm PopConfirm_open">
					<span><?php echo lang('buttons.delete'); ?></span>
				</button>
				<?php break;
			case 're-index': ?>
				<button type="submit" name="btnAction" value="re-index" class="btn btn-success">
