...
class Theme_paradise extends Theme {

    public $name			= 'Berita Web Template';
    public $author			= 'Doni';
    public $author_website	= 'http://www.suara-jakarta.com/';
    public $website			= 'http://www.suara-jakarta.com/';
    public $description		= 'Default Berita v1.0 Theme - 2 Column, Fixed width, Horizontal navigation, CSS3 styling.';
    public $version			= '1.0';
